...
public class EnsembleAuthenticationProviderTest {
    ...
    public static void setupBeforeClass() {
        loggerTestTool = new LoggerTestTool(EnsembleAuthenticationProvider.class);
    }
    ...
    public void testLogForgeryWithSpecialCharacters() throws IOException {
        ...
        String logLine = loggerTestTool.getOutputStream().toString(StandardCharsets.UTF_8.name());
